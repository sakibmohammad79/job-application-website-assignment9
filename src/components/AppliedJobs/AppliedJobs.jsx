...
const AppliedJobs = () => {
    ...
    return (
        <div className='md:w-[1120px] mx-auto my-28'>
            ...
            <button className='drop-shadow rounded mr-3 font-bold bg-orange-500 hover:bg-orange-700 py-2 px-4 text-white'>Remote</button>
            <button className='drop-shadow font-bold bg-orange-500 hover:bg-orange-700 py-2 px-4 rounded text-white'>Onsite</button>
            </div>
            {
